...
- **FR-013**: System MUST handle Start.gg API rate limits gracefully (max 80 requests per 60 seconds) with retry/backoff strategies.
...
| ----- | ------------------------------- | -------- | ------------- |
| 0     | Foundation & Scaffold           | Prereq   | —             |
| 1     | Player Registration Bot         | P1       | Phase 0       |
| 2     | Start.gg Match Coordination     | P1       | Phases 0 + 1  |
| 3     | AI Referee Agent                | P1       | Phase 2       |
| 4     | Admin Web Dashboard             | P2       | Phase 2       |
| 5     | AI Admin Assistant              | P3       | Phase 4       |
