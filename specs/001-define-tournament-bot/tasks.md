...
- [ ] T056 Run quickstart.md validation — execute full setup flow, verify all services start, create a test tournament, register two players, complete a match end-to-end
