...
async def delete_asset(name: str):
    ...
    # Optional: confirm it actually resolves inside ASSETS_DIR as an extra check
    if os.path.commonpath([os.path.abspath(file_path), os.path.abspath(ASSETS_DIR)]) != os.path.abspath(ASSETS_DIR):
