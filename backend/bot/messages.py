MESSAGES = {
    "en": {
        ...
        "bio_confirmed_new": "✅ Account control confirmed as **{gamer_tag}**! You can remove the code from your bio.\n\n📸 One last step for broadcast: **DM me a photo** (min 100x100, square-ish) to use as your player avatar. Once it passes our quality check you'll be fully verified.",
        ...
        "avatar_send_new": "📸 Sure — please **DM me a new photo** (min 100x100, square-ish) and I'll set it as your broadcast avatar.",
        ...
        "avatar_cmd_prompt": "📸 Please **DM me a photo** (min 100x100, square-ish) to set as your broadcast avatar. Once it passes our quality check it'll be saved.",
    ...
    "ar": {
        ...
        "bio_confirmed_new": "✅ تم تأكيد ملكية الحساب باسم **{gamer_tag}**! يمكنك الآن إزالة الرمز من سيرتك الذاتية.\n\n📸 خطوة أخيرة للبث: **أرسل لي صورة** (بحد أدنى 100x100، قريبة من المربّع) لاستخدامها كصورة رمزية للاعب. بمجرد اجتيازها فحص الجودة سيكتمل تحققك.",
        ...
        "avatar_send_new": "📸 بالتأكيد — يرجى **إرسال صورة جديدة لي** (بحد أدنى 100x100، قريبة من المربّع) وسأضبطها كصورتك الرمزية للبث.",
        ...
        "avatar_cmd_prompt": "📸 يرجى **إرسال صورة لي** (بحد أدنى 100x100، قريبة من المربّع) لضبطها كصورتك الرمزية للبث. سيتم حفظها بمجرد اجتيازها فحص الجودة.",
