...
3. call_match_tool: Call a tracked match into check-in (not_started -> called) by its set_id. The bot opens the standard check-in thread; players must ready up before it goes in-progress.
