...
export function MatchDashboard() {
  ...
  // ⚡ Bolt Optimization: Memoize the mappedMatches array computation to prevent expensive O(n) iteration
  // and object allocation on every render, especially when 'matches' or 'sets' grow large.
